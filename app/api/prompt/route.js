...
export const POST = async (request) => {
  ...
  const DEFAULT_PROMPT = `Using the pronunciation of the following characters (within another word as a play on words) and the word ${keyword}, write a one sentence story: ${onyomi}  ${kunyomi}. Don't use the japanese characters. Don't use names.`;
