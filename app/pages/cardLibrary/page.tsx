  ...
  return (
    <div className="flex flex-col gap-2 justify-center items-center">
      ...
      <div className="w-full flex justify-center items-center text-2xl gap-3 my-8">
          {page < 3 ? (
            <>
              <button onClick={() => setPage(1)} className="btn-secondary">Start</button>
              <button onClick={() => setPage((prev) => prev - 1)} className="btn-secondary">
                <svg
              ...
              <button onClick={() => setPage(1)} className={`${page === 1 ? 'font-bold' : ''} text-blue-500`}>1</button>
              <button onClick={() => setPage(2)} className={`${page === 2 ? 'font-bold' : ''} text-blue-500`}>2</button>
              <button onClick={() => setPage(3)} className={`${page === 3 ? 'font-bold' : ''} text-blue-500`}>3</button>
              <button onClick={() => setPage(4)} className={`${page === 4 ? 'font-bold' : ''} text-blue-500`}>4</button>
              <button onClick={() => setPage(5)} className={`${page === 5 ? 'font-bold' : ''} text-blue-500`}>5</button>
              <button onClick={() => setPage((prev) => prev + 1)} className="btn-secondary">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
              ...
              <button onClick={() => setPage(Math.ceil(kanjiObjectArray.length/50))} className="btn-secondary">End</button>
            </>
          ) : (
            <>
              <button onClick={() => setPage(1)} className="btn-secondary">Start</button>
              ...
              <button onClick={() => setPage(page-2)} className="text-blue-500">{page-2}</button>
              <button onClick={() => setPage(page-1)} className="text-blue-500">{page-1}</button>
              <button onClick={() => setPage(page)} className="font-bold text-blue-500">{page}</button>
              <button onClick={() => setPage(page+1)} className="text-blue-500">{page+1}</button>
              <button onClick={() => setPage(page+2)} className="text-blue-500">{page+2}</button>
              <button onClick={() => setPage((prev) => prev + 1)} className="btn-secondary">
                <svg
